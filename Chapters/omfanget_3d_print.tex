...
\paragraph{En teknologisk udvikling} % (fold)
...
% paragraph en_teknologisk_udvikling (end)

\paragraph{Fordelene} % (fold)
\label{par:fordelene}
...
% paragraph fordelene (end)

\paragraph{Ulemperne} % (fold)
\label{par:ulemperne}
...
% paragraph ulemperne (end)

\paragraph{En del af husstanden} % (fold)
...
% paragraph en_del_af_husstanden (end)
