...
\subsubsection{Problemer} % (fold)
\label{ssub:problemer}

% subsubsection problemer (end)
...
\input{Chapters/leje-print}

\subsection{Fælles for de 2 platforme} % (fold)


\subsubsection{Mærkevare} % (fold)
\label{ssub:m_rkevare}

% subsubsection m_rkevare (end)
...
\subsubsection{Patenter} % (fold)
\label{ssub:patenter}

% subsubsection patenter (end)
...
\subsubsection{Salg af 3D-printere} % (fold)
\label{ssub:salg_af_3d_printere}

% subsubsection salg_af_3d_printere (end)
